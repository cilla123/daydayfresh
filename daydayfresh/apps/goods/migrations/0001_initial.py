    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 216728), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '轮播的商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('goods_sn', models.CharField(default='', max_length=50, verbose_name='商品唯一号')),
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 214784), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 212205), help_text='添加时间', verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父类目级别', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_category', to='goods.GoodsCaegory', verbose_name='父类目级别')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 213234), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '品牌',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 215859), verbose_name='添加时间')),
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCaegory', verbose_name='商品类目'),
        ),
        migrations.AddField(
            model_name='banner',
            name='goods',
