    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 219973), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '订单商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nonce_str', models.CharField(blank=True, max_length=50, null=True, verbose_name='随机字符串')),
                ('trade_no', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='订单')),
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 219178), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '订单信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2017, 11, 20, 12, 41, 42, 218133), verbose_name='添加时间')),
